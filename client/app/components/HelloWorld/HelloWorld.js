      ...
      <div className="box" id="box">
        <div className="field" id="fNameField">
          ...
          <div className="control" id="fNameControl">
            <input className="input" type="text" id="firstName" placeholder="First Name" required="required"/>
          </div>
        </div>
        ...
        <div className="field">
          ...
          <div className="control">
            <input className="input" type="text" id="lastName" placeholder="Last Name" required="required"/>
          </div>
        </div>
        ...
        <div className="field">
          ...
          <div className="control">
            <input className="input" type="email" id="email" placeholder="Email input" required="required"/>
          </div>
        </div>
        ...
        <div className="field">
          ...
          <div className="control">
            <input className="input" type="text" id="subject" placeholder="Subject of Email" required="required"/>
          </div>
        </div>
        ...
        <div className="field">
          ...
          <div className="control">
            <textarea className="textarea" id="message" placeholder="Enter your message!" required="required"></textarea>
          </div>
        </div>
        ...
        <div className="field">
          <div className="control">
            <label className="checkbox">
              <input type="checkbox" id="checkbox" required="required"/>&nbsp; I agree to the
              <a href="#">
